    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        contentPadding: EdgeInsets.symmetric(
          ...
          vertical: widget.contentPaddingVertical ?? 6.h, // reduced vertical padding
        ),
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: showYearPicker ? widget.primaryColor.withOpacity(0.1) : Colors.transparent,
          ...
          return GestureDetector(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                border: isCurrentYear ? Border.all(color: widget.primaryColor) : null,
                borderRadius: BorderRadius.circular(8),
              ),
              child: Center(
                child: Text(
